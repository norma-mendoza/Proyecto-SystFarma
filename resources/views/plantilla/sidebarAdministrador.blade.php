    ...
    <nav class="sidebar-nav navbar-dark" >
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li @click="menu=1" class="nav-item">
                        <a class="nav-link" href="#"><i class=""></i>
                            Categorías</a>
                    </li>
                    <li @click="menu=2" class="nav-item">
                        <a class="nav-link" href="#"><i class=""></i> Productos</a>
                    </li>
                    <li @click="menu=3" class="nav-item">
                        <a class="nav-link" href="#"><i class=""></i> Presentacion</a>
                    </li>
                    <li @click="menu=4" class="nav-item">
                        <a class="nav-link" href="#"><i class=""></i> Laboratorio</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item nav-dropdown">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li @click="menu=9" class="nav-item d-none">
